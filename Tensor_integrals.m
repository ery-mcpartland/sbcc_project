...
CreateAmplitude[num_,denom_]:=FullSimplify[(\[LeftAngleBracket]\[ScriptU][p-q,0], num ,\[ScriptU][p,mb]\[RightAngleBracket]//FermionLineExpand//Simplify )/denom]
...
PropagatorReplace["a",amp_]:=FullSimplify[amp /. {l . l->mc^2+P2,r . r->P4,l . r->1/2 (-P2+P3-P4),l . p->P7+P9,p . r->1/2 (-mb^2-P4+P8),l . q->P9,
q . r->1/2 (-mb^2-P5+P8),p . q->1/2 (mb^2+q . q),p . p->mb^2}]


PropagatorReplace["b",amp_]:=FullSimplify[amp /. {l . l->mc^2+P2,r . r->P4,l . r->1/2 (-P2+P3-P4),l . p->P7+P9,p . r->1/2 (-P4+P8),l . q->P9,
q . r->1/2 (-mb^2-P5+P8),p . q->1/2 (mb^2+q . q),p . p->mb^2}]
...
PropagatorReplace["d",amp_]:=FullSimplify[amp /. {l . l->mc^2+P2,r . r->P4,l . r->1/2 (-P1+P12-P4-2 P6),l . p->1/2 (P1-P2+2 P7-q . q),p . r->(P11-P4)/2,
l . q->1/2 (P1-P2-q . q),q . r->P6,p . q->1/2 (mb^2+q . q),p . p->mb^2}]
...
Solve[P2==l . l-mc^2&&P3==(l+r) . (l+r)-mc^2&&P4==r . r&&P5==(r+p-q) . (r+p-q)&&P8==(r+p) . (r+p)&&P7==l . (p-q)&&P9=={l . q}&&(p-q) . (p-q)==0&&(p . p)==mb^2,
{l . l,r . r,l . r,l . p,r . p,l . q,r . q,p . q,p . p}]
...
Solve[P2==l . l-mc^2&&P3==(l+r) . (l+r)-mc^2&&P4==r . r&&P5==(r+p-q) . (r+p-q)-mb^2&&P8==(r+p) . (r+p)-mb^2&&P7==l . (p-q)&&P9=={l . q}&&(p-q) . (p-q)==0&&(p . p)==mb^2,
{l . l,r . r,l . r,l . p,r . p,l . q,r . q,p . q,p . p}]
...
Solve[P1==(l+q) . (l+q)-mc^2&&P2==l . l-mc^2&&P3==(l+r) . (l+r)-mc^2&&P4==r . r&&P5==(r+p-q) . (r+p-q)&&P6==r . q&&P7==l . (p-q)&&(p-q) . (p-q)==0&&(p . p)==mb^2,
{l . l,r . r,l . r,l . p,r . p,l . q,r . q,p . q,p . p}]
...
Solve[P1==(l+q) . (l+q)-mc^2&&P2==l . l-mc^2&&P12==(l+r+q) . (l+r+q)-mc^2&&P4==r . r&&P11==(r+p) . (r+p)-mb^2&&P6==r . q&&P7==l . (p-q)&&(p-q) . (p-q)==0&&(p . p)==mb^2,
{l . l,r . r,l . r,l . p,r . p,l . q,r . q,p . q,p . p}]
